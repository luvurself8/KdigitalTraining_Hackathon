...
kakao.maps.event.addListener(n1, 'click', function() {
	n1.setOptions({fillColor: 'yellow'});
...
kakao.maps.event.addListener(n2, 'click', function() {
    ...
    var content = '<div class="info">' + 
				  ...
				  '				<th style="background-color: red; color:white; border: 1px solid #ccc;"><span class="danger">&nbsp; 위험 &nbsp;</span></th>'+
				  '			</tr>'+
				  '		</table>'+
                  '		</li>'+
                  '		<li>'+
                  '   		<span class="iTitle">확률</span>'+
				  '			<span class="iBody"><b>72%</b></span>'+
                  '		</li>'+
                  '		<li>'+
	  			  '			<span class="iTitle">행동요령</span>'+
                  '		</li>'+
				  ...
				  '	<ol>'+
				  '		<li>기상악화가 예상되는 경우, 안전한 항구나 보호구역으로 이동하는 것을 고려하세요.</li>'+
				  '		<li>선원 모두가 닻 끌림 위험에 대해 인식하고, 모니터링 및 상호간의 의사소통을 강화하세요.</li>'+
				  '		<li>닻 고정 시설물의 강도를 점검하고, 필요한 경우 추가적인 앵커 시스템을 설치하여 안정성을 강화하세요. 비상용 앵커와 송두리째에 줄을 준비하세요.</li>'+
				  '		<li>인근 해상교통관제센터에 연락하여 현재 상황을 공유하세요.<br>'+
				  '			<a href="https://www.kcg.go.kr/kcg/si/sub/info.do?page=2836&num=09&mi=2836"'+
				  '			 style="color:blue;">부산부산항 해상교통관제센터&nbsp;</a>TEL: 051)664-2750</li>'+
				  '	</ol>'+
                  '	</div>';
